...
@Test func searchInStaticQuadTree() async throws {
    ...
    let results = quadTree.search(in: CGRect(x: 0, y: 0, width: 60, height: 60))
...
@Test func overlappingAreasStaticQuadTree() async throws {
    ...
    let results = quadTree.search(in: CGRect(x: 12, y: 12, width: 5, height: 5))
...
@Test func outOfBoundsInsertionStaticQuadTree() async throws {
    ...
    let results = quadTree.search(in: CGRect(x: 0, y: 0, width: 100, height: 100))
